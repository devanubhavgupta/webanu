        ...
        <section id='projects' className='py-24 px-4 relative'>
            <div className='container mx-auto max-w-5xl '>
                ...
                <p className='text-center text-muted-foreground mb-12 max-w-2xl mx-auto'>
                    Here are some of recent projects. Each project was carefully crafted with attention
                    to detail and a focus on delivering an exceptional user experience.
                </p>
                            ...
                            <div className='p-6'>
                                <div className='flex flex-wrap gap-2 mb-4'>
                                    {project.tags.map((tag) => (
                                        <span className='px-2 py-1 border text-xs font-medium rounded-full bg-secondry text-secondry-foreground'>
                                            {tag}
                                        </span>
                                    ))}
                                </div>
                ...
                <div className='text-center mt-12'>
                    <a
                        ...
                        href='https://github.com/devanubhavgupta'
                        target='_blank'
                    >
